...
<img src="/images/project/4_service.png" width="100%" alt="서비스 검색 및 추천 결과 화면" style="border-radius: 8px; border: 1px solid #eee;" />
<p align="center" style="color: gray; font-size: 0.9em; margin-top: 5px;">▲ Flask로 구현된 영화 추천 웹 서비스 시연 화면</p>
...
<img src="/images/project/4_arch.png" width="100%" alt="전체 시스템 아키텍처" style="border-radius: 8px; border: 1px solid #eee;" />
<p align="center" style="color: gray; font-size: 0.9em; margin-top: 5px;">▲ Azure Databricks와 Flask를 연동한 전체 시스템 아키텍처</p>
...
<img src="/images/project/4_serving.png" width="100%" alt="MLflow 서빙 로그" style="border-radius: 8px; border: 1px solid #eee;" />
<p align="center" style="color: gray; font-size: 0.9em; margin-top: 5px;">▲ MLflow Model Serving Endpoint 구성 및 로그</p>
...
<img src="/images/project/4_perf.png" width="100%" alt="모델 성능 비교표" style="border-radius: 8px; border: 1px solid #eee;" />
<p align="center" style="color: gray; font-size: 0.9em; margin-top: 5px;">▲ BERT 모델의 압도적인 성능 지표</p>
...
<div style="display: flex; justify-content: space-between; margin-top: 50px;">
  <a href="/project/3" style="text-decoration: none; font-weight: bold; color: #333;">⬅️ 이전 프로젝트: 권역 외상 센터 입지 선정</a>
