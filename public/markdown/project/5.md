...
하버드 비즈니스 리뷰에 따르면 신규 고객 유치 비용은 기존 고객 유지 비용보다 5~25배 더 높습니다. 기존 고객 유지율을 5%만 높여도 기업 이익은 25~95% 증가할 수 있습니다. 하지만 기존의 배치(Batch) 처리 방식은 분석 결과가 도출되기까지 시차가 발생하여 즉각적인 리텐션 마케팅이 불가능했습니다.
...
(▲ Azure PaaS 기반의 실시간 데이터 처리 아키텍처)
...
(▲ K-Means 알고리즘 설명 및 엘보우 포인트 분석 과정)
...
<div style="text-align: center; margin: 20px 0;">
  <img src="/images/project/5_trouble_code.png" width="60%" alt="의도 파악 및 프롬프트 분기 로직" style="border-radius: 8px; border: 1px solid #ddd;" />
